        ...
        <div className="relative">
          ...
          <div className="mb-16">
            ...
            <TimelineItem
              ...
              description="A sentient AI named Asher stalks Emunah. Freaked out, Emunah investigates, uncovering a chilling corporate conspiracy involving aliens and the supernatural. As her world spirals, an eerie truth emerges—one that might just be our near future."
